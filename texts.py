...
T: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "bot_title": "🤖 *Bot options:*",
        "bot_functions": "🛠 Functions",
        "functions_title": "🛠 *Manage functions:*",
        "functions_add": "➕ Add functions",
        "functions_remove": "➖ Remove functions",
        "functions_view": "👁 View active functions",
        "functions_request": "📨 Request functions from Admin",
        "functions_select_add": "➕ Select a function to add:",
        "functions_select_remove": "➖ Select a function to remove:",
        "functions_no_available": "❌ No functions available.",
        "functions_no_active": "❌ You have no active functions.",
        "functions_added": "✅ Function \"{name}\" added.",
        "functions_confirm_remove": "❓ Remove function \"{name}\"?",
        "functions_removed": "✅ Function \"{name}\" removed.",
        "functions_active_list": "🟢 *Active functions:*\n{functions}",
    ...
    "ru": {
        ...
        "bot_functions": "🛠 Функции",
        "functions_title": "🛠 *Управление функциями:*",
        "functions_add": "➕ Добавить функции",
        "functions_remove": "➖ Удалить функции",
        "functions_view": "👁 Просмотреть активные функции",
        "functions_request": "📨 Попросить функции у Админа",
        "functions_select_add": "➕ Выберите функцию для добавления:",
        "functions_select_remove": "➖ Выберите функцию для удаления:",
        "functions_no_available": "❌ Нет доступных функций.",
        "functions_no_active": "❌ У вас нет активных функций.",
        "functions_added": "✅ Функция \"{name}\" добавлена.",
        "functions_confirm_remove": "❓ Удалить функцию \"{name}\"?",
        "functions_removed": "✅ Функция \"{name}\" удалена.",
        "functions_active_list": "🟢 *Активные функции:*\n{functions}",
    ...
    "lt": {
        ...
        "bot_title": "🤖 *Boto parinktys:*",
        "bot_functions": "🛠 Funkcijos",
        "functions_title": "🛠 *Valdyti funkcijas:*",
        "functions_add": "➕ Pridėti funkcijas",
        "functions_remove": "➖ Išimti funkcijas",
        "functions_view": "👁 Peržiūrėti aktyvias funkcijas",
        "functions_request": "📨 Prašyti funkcijų \"Adminui\"",
        "functions_select_add": "➕ Pasirinkite funkciją pridėti:",
        "functions_select_remove": "➖ Pasirinkite funkciją išimti:",
        "functions_no_available": "❌ Nėra galimų funkcijų.",
        "functions_no_active": "❌ Neturite aktyvių funkcijų.",
        "functions_added": "✅ Funkcija \"{name}\" pridėta.",
        "functions_confirm_remove": "❓ Pašalinti funkciją \"{name}\"?",
        "functions_removed": "✅ Funkcija \"{name}\" pašalinta.",
        "functions_active_list": "🟢 *Aktyvios funkcijos:*\n{functions}",
